import {
  ...
  import CulturalSits from 'src/components/Common/Tourism/CulturalSits';
  import ThemePark from 'src/components/Common/Tourism/ThemePark';
  // import GDPCard from 'src/components/Common/Health/GDPCard';
  import Occupancy from 'src/components/Common/Tourism/Occupancy';
  import Guests from 'src/components/Common/Tourism/Guests';
  import Revpar from '@/components/Common/Tourism/Revpar';
  import MallsFootball from '@/components/Common/Tourism/MallsFootfall';
