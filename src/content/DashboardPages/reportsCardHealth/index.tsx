...
import HealthColumn from 'src/content/Dashboards/Crypto/HealthColumn';
...
function HealthReportsContent() {
  ...
  return (
    <>
      <PageTitleWrapper>
        <Card style={{ marginLeft: "-25px", marginRight: "-25px", marginBottom: "-15px", display: "flex", justifyContent: "flex-start" }}>
          <div style={{ marginTop: "9px", marginLeft: "9px" }}><FavoriteTwoToneIcon fontSize='large' /></div>
