...
const Yachtrequest = React.lazy(() => import('./views/components/base/yachtrequest/Yachtrequest'))
const Yachttype = React.lazy(() => import('./views/components/base/yachttype/yachttype'))

// const EmployeeOffice = React.lazy(() => import('./views/components/base/employeeOffice/employeeOffice'))
const OfficePercentage = React.lazy(() => import('./views/components/base/officePercentage/officePercentage'))
const ImpactAnalysis = React.lazy(() => import('./views/components/base/impactAnalysis/impactAnalysis'))
// const EmployeeHome = React.lazy(() => import('./views/components/base/employeeHome/employeeHome'))
const Bookings = React.lazy(() => import('./views/components/base/bookings/booking'))
const UsersList = React.lazy(() => import('./views/components/base/usersList'))

const Yacht = React.lazy(() => import('./views/components/base/yacht/yacht'))
const AddYacht = React.lazy(() => import('./views/components/base/yacht/addYacht'))
const UpdateYatch = React.lazy(() => import('./views/components/base/yacht/updateYacht'))
...
// const ImpactAnalysisBase = React.lazy(() => import('./views/imapactAnalysis'))
...
const routes = [
  ...
  { path: '/base/Yachtrequest', name: 'Yachtrequest', component: Yachtrequest },
  // { path: '/base/EmployeeOffice', name: 'EmployeeOffice', component: EmployeeOffice },
  { path: '/base/OfficePercentage', name: 'OfficePercentage', component: OfficePercentage },
  // { path: '/base/ImpactAnalysis', name: 'ImpactAnalysis', component: ImpactAnalysisBase },
  // { path: '/base/EmployeeHome', name: 'EmployeeHome', component: EmployeeHome },
  { path: '/base/Exchanges', name: 'Exchanges', component: Bookings },
  { path: '/base/users', name: 'Users', component: UsersList },

  { path: '/base/YachtType', name: 'yachttype', component: Yachttype },
  { path: '/base/Yacht', name: 'Yacht', component: Yacht },
  { path: '/base/addYacht', name: 'addYacht', component: AddYacht },
  { path: '/base/updateYacht', name: 'updateYatch', component: UpdateYatch },
